...
rm -f update-d && cardano-cli governance create-update-proposal \
            ...
            --decentralization-parameter 0.0 --protocol-major-version 6 --protocol-minor-version 0
...
rm -f tx6u.txbody && cardano-cli transaction build-raw \
            --alonzo-era \
            --fee ${FEE} \
            --tx-in $TXID\
...
cardano-cli transaction sign \
            ...
            --testnet-magic 141 \
            --tx-body-file  tx6u.txbody \
            --out-file      tx6u.tx


cardano-cli transaction submit --tx-file tx6u.tx --testnet-magic 141
