...
rm -f tx7u.txbody && cardano-cli transaction build-raw \
            --alonzo-era \
            --fee ${FEE} \
            --tx-in $TXID\
...
cardano-cli transaction sign \
            ...
            --testnet-magic 141 \
            --tx-body-file  tx7u.txbody \
            --out-file      tx7u.tx


cardano-cli transaction submit --tx-file tx7u.tx --testnet-magic 141
