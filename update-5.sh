...
rm -f update-proposal-alonzo && cardano-cli governance create-update-proposal \
...
rm -f tx4.txbody && cardano-cli transaction build-raw \
            --mary-era \
            --fee ${FEE} \
            --tx-in $TXID#0\
...
cardano-cli transaction submit --tx-file tx4.tx --testnet-magic 141
...
#cardano-cli transaction submit --cardano-mode --testnet-magic 141 --tx-file mary.tx
